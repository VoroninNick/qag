        ...
        this.each(function () {
            ...
            $form.find('input, textarea').each(function () {
                ...
                var validateField = function (e) {
                    ...
                    var $targetForAddClass = options.addClassToParent ? $this.parent() : $this

                    if (errors.length > 0 && hasBeenBlurredWhileDirty) {
                        $targetForAddClass.addClass(options.errorClass);
                        $targetForAddClass.removeClass(options.validClass);
                        if (typeof options.onError === 'function') options.onError.call(this, errors);
                    } else if (errors.length === 0) {
                        $targetForAddClass.addClass(options.validClass);
                        $targetForAddClass.removeClass(options.errorClass);
